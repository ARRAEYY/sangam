        ...
        <div className="py-20 flex flex-col items-center gap-4 text-center bg-[#faf9f5] rounded-[24px] border-2 border-dashed border-slate-200 reveal-in delay-1">
          ...
          <div>
            ...
            <p className="text-slate-500 mb-6 max-w-md mx-auto">
              You aren't leading any projects yet. You can start your own project or explore existing ones to join a team.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link to="/create" className="btn-primary inline-flex items-center gap-2">
                Start a New Project <ArrowRight size={16} />
              </Link>
              <Link to="/explore" className="inline-flex items-center justify-center px-6 py-2.5 bg-white text-slate-700 font-semibold text-sm rounded-lg hover:bg-slate-50 border border-slate-200 transition-colors shadow-sm">
                Join a Project
              </Link>
            </div>
          </div>
